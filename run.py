...
from gui.window import PyqtMainWindow, show_homework_window
...
def main() -> None:
    ...
    show_homework_window(homework_list= my_search.homework_list,display_elements= my_search.display_elements)
